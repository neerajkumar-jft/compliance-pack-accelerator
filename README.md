...
- **Dashboard**: `Compliance Pack Platform` (10 pages), uploaded by `databricks bundle deploy`.
- **Notebooks**: deployed under `/Workspace/Users/<your-email>/.bundle/compliance-pack/dev/files/notebooks/` by the bundle.
...
`<you>+compliance-{cco,gc,cmo,cfo}@<your-domain>` users (all login tokens route
